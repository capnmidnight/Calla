...
export { AudioActivityEvent, AudioListenerBase, AudioListenerNew, AudioListenerOld, AudioManager, BaseListener, BaseRoutedSource, BaseSource, BaseSpatializer, CallaClient, EventBase, InterpolatedPose, MockAudioContext, PannerBase, PannerNew, PannerOld, Pose, ResonanceScene, ResonanceSource, add, addEventListeners, arrayClear, arrayRandom, arrayRemove, arrayRemoveAt, arrayScan, canChangeAudioOutput, clamp, isBoolean, isFunction, isGoodNumber, isNumber, isString, lerp, once, project, slerpVectors, unproject, until, versionString, wait, when };
