...
class TestRunner extends EventBase {
...
class TestOutput extends EventBase {
    constructor(...rest) {
        super();
        this.rest = rest;
    }
...
class TestCase extends EventBase {
    setup() { }
    teardown() { }
    message(msg) {
        msg = msg || "N/A";
...
const TEST_ROOM_NAME$1 = "testroom";
...
class JitsiClient1_Tests extends TestBase {
    ...
    async test_999_leaveConference() {
        ...
        this.isEqualTo(evt.roomName, TEST_ROOM_NAME$1, "Room Name");
    }
}
