 ...
 **/
export class CssProp implements IAppliable {
    /**
...
export function content(v: string) { return new CssProp("content", v); }
...
export function size(v: string) { return new CssProp("size", v); }
export function speak(v: string) { return new CssProp("speak", v); }
export function src(v: string) { return new CssProp("src", v); }
...
export function zIndex(v: string) { return new CssProp("zIndex", v); }
export function zoom(v: string) { return new CssProp("zoom", v); }
