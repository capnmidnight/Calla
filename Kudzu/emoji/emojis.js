...
function sym(symbol, name) {
    const j = new Emoji(symbol.value, name), men = J(man.default, j), women = J(woman.default, j);
...
export const gestures = new EmojiGroup("Gestures", "Gestures", frowners, pouters, gesturingNo, gesturingOK, tippingHand, raisingHand, bowing, facePalming, shrugging, cantHear, gettingMassage, gettingHaircut);
