...
export const plants = g("Plants", "Flowers, trees, and things", e("\u{1F331}", "Seedling"), e("\u{1F332}", "Evergreen Tree"), e("\u{1F333}", "Deciduous Tree"), e("\u{1F334}", "Palm Tree"), e("\u{1F335}", "Cactus"), e("\u{1F337}", "Tulip"), e("\u{1F338}", "Cherry Blossom"), e("\u{1F339}", "Rose"), e("\u{1F33A}", "Hibiscus"), e("\u{1F33B}", "Sunflower"), e("\u{1F33C}", "Blossom"), sheafOfRice, e("\u{1F33F}", "Herb"), e("\u{1F340}", "Four Leaf Clover"), e("\u{1F341}", "Maple Leaf"), e("\u{1F342}", "Fallen Leaf"), e("\u{1F343}", "Leaf Fluttering in Wind"), E("\u{1F3F5}", "Rosette"), e("\u{1F490}", "Bouquet"), whiteFlower, e("\u{1F940}", "Wilted Flower"), 
...
export const zodiac = g("Zodiac", "The symbology of astrology", e("\u2648", "Aries"), e("\u2649", "Taurus"), e("\u264A", "Gemini"), e("\u264B", "Cancer"), e("\u264C", "Leo"), e("\u264D", "Virgo"), e("\u264E", "Libra"), e("\u264F", "Scorpio"), e("\u2650", "Sagittarius"), e("\u2651", "Capricorn"), e("\u2652", "Aquarius"), e("\u2653", "Pisces"), e("\u26CE", "Ophiuchus"));
...
export const writing = g("Writing", "Writing", E("\u{1F58A}", "Pen"), E("\u{1F58B}", "Fountain Pen"), E("\u{1F58C}", "Paintbrush"), E("\u{1F58D}", "Crayon"), E("\u270F", "Pencil"), E("\u2712", "Black Nib"));
...
export const household = g("Household", "Household", e("\u{1F484}", "Lipstick"), e("\u{1F48D}", "Ring"), e("\u{1F48E}", "Gem Stone"), e("\u{1F4F0}", "Newspaper"), key, e("\u{1F525}", "Fire"), e("\u{1F52B}", "Pistol"), E("\u{1F56F}", "Candle"), E("\u{1F5BC}", "Framed Picture"), oldKey, E("\u{1F5DE}", "Rolled-Up Newspaper"), E("\u{1F5FA}", "World Map"), door, e("\u{1F6BD}", "Toilet"), e("\u{1F6BF}", "Shower"), e("\u{1F6C1}", "Bathtub"), E("\u{1F6CB}", "Couch and Lamp"), E("\u{1F6CF}", "Bed"), e("\u{1F9F4}", "Lotion Bottle"), e("\u{1F9F5}", "Thread"), e("\u{1F9F6}", "Yarn"), e("\u{1F9F7}", "Safety Pin"), e("\u{1F9F8}", "Teddy Bear"), e("\u{1F9F9}", "Broom"), e("\u{1F9FA}", "Basket"), e("\u{1F9FB}", "Roll of Paper"), e("\u{1F9FC}", "Soap"), e("\u{1F9FD}", "Sponge"), e("\u{1FA91}", "Chair"), e("\u{1FA92}", "Razor"), E("\u{1F397}", "Reminder Ribbon"));
export const activities = g("Activities", "Activities", E("\u{1F39E}", "Film Frames"), E("\u{1F39F}", "Admission Tickets"), e("\u{1F3A0}", "Carousel Horse"), e("\u{1F3A1}", "Ferris Wheel"), e("\u{1F3A2}", "Roller Coaster"), artistPalette, e("\u{1F3AA}", "Circus Tent"), e("\u{1F3AB}", "Ticket"), e("\u{1F3AC}", "Clapper Board"), e("\u{1F3AD}", "Performing Arts"));
export const travel = g("Travel", "Travel", E("\u{1F3F7}", "Label"), e("\u{1F30B}", "Volcano"), E("\u{1F3D4}", "Snow-Capped Mountain"), E("\u26F0", "Mountain"), E("\u{1F3D5}", "Camping"), E("\u{1F3D6}", "Beach with Umbrella"), E("\u26F1", "Umbrella on Ground"), e("\u{1F3EF}", "Japanese Castle"), e("\u{1F463}", "Footprints"), e("\u{1F5FB}", "Mount Fuji"), e("\u{1F5FC}", "Tokyo Tower"), e("\u{1F5FD}", "Statue of Liberty"), e("\u{1F5FE}", "Map of Japan"), e("\u{1F5FF}", "Moai"), E("\u{1F6CE}", "Bellhop Bell"), e("\u{1F9F3}", "Luggage"), e("\u26F3", "Flag in Hole"), e("\u26FA", "Tent"), E("\u2668", "Hot Springs"));
export const medieval = g("Medieval", "Medieval", e("\u{1F3F0}", "Castle"), e("\u{1F3F9}", "Bow and Arrow"), crown, e("\u{1F531}", "Trident Emblem"), E("\u{1F5E1}", "Dagger"), E("\u{1F6E1}", "Shield"), e("\u{1F52E}", "Crystal Ball"), E("\u2694", "Crossed Swords"), E("\u269C", "Fleur-de-lis"));
