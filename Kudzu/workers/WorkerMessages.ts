...
export enum WorkerClientMessageType {
...
export interface WorkerClientMethodCallMessage
    extends WorkerClientMessage<WorkerClientMessageType.MethodCall> {
    methodName: string;
    params?: any[];
}

export interface WorkerClientPropertySetMessage
    extends WorkerClientMessage<WorkerClientMessageType.PropertySet> {
    propertyName: string;
    value: any;
}
