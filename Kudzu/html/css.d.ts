...
export declare function height(v: string | 0): CssProp;
...
export declare function width(v: string | 0): CssProp;
...
export declare function x(v: string | 0): CssProp;
export declare function y(v: string | 0): CssProp;
export declare function zIndex(v: number): CssProp;
