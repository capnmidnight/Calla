...
export class Texture extends ManagedWebGLResource<WebGLTexture> {
    constructor(gl: WebGL2RenderingContext, image: TexImageSource, pixelType: GLenum = gl.RGBA, componentType: GLenum = gl.UNSIGNED_BYTE) {
