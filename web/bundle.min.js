 ...
 * limitations under the License.
 */
const n=i(3),s=i(0);function o(e,t){null==t&&(t={}),null==t.ambisonicOrder&&(t.ambisonicOrder=s.DEFAULT_AMBISONIC_ORDER),null==t.azimuth&&(t.azimuth=s.DEFAULT_AZIMUTH),null==t.elevation&&(t.elevation=s.DEFAULT_ELEVATION),null==t.sourceWidth&&(t.sourceWidth=s.DEFAULT_SOURCE_WIDTH),this._context=e,this.input=e.createGain(),this._channelGain=[],this._merger=void 0,this.output=e.createGain(),this.setAmbisonicOrder(t.ambisonicOrder),this._azimuth=t.azimuth,this._elevation=t.elevation,this.setSourceWidth(t.sourceWidth)}o.prototype.setAmbisonicOrder=function(e){this._ambisonicOrder=o.validateAmbisonicOrder(e),this.input.disconnect();for(let e=0;e<this._channelGain.length;e++)this._channelGain[e].disconnect();null!=this._merger&&this._merger.disconnect(),delete this._channelGain,delete this._merger;let t=(this._ambisonicOrder+1)*(this._ambisonicOrder+1);this._merger=this._context.createChannelMerger(t),this._channelGain=new Array(t);for(let e=0;e<t;e++)this._channelGain[e]=this._context.createGain(),this.input.connect(this._channelGain[e]),this._channelGain[e].connect(this._merger,0,e);this._merger.connect(this.output)},o.prototype.setDirection=function(e,t){(null==e||isNaN(e))&&(e=s.DEFAULT_AZIMUTH),(null==t||isNaN(t))&&(t=s.DEFAULT_ELEVATION),this._azimuth=e,this._elevation=t,(e=Math.round(e%360))<0&&(e+=360),t=Math.round(Math.min(90,Math.max(-90,t)))+90,this._channelGain[0].gain.value=n.MAX_RE_WEIGHTS[this._spreadIndex][0];for(let i=1;i<=this._ambisonicOrder;i++){let s=n.MAX_RE_WEIGHTS[this._spreadIndex][i];for(let o=-i;o<=i;o++){let a=i*i+i+o,r=i*(i+1)/2+Math.abs(o)-1,l=n.SPHERICAL_HARMONICS[1][t][r];if(0!=o){let t=n.SPHERICAL_HARMONICS_MAX_ORDER+o-1;o<0&&(t=n.SPHERICAL_HARMONICS_MAX_ORDER+o),l*=n.SPHERICAL_HARMONICS[0][e][t]}this._channelGain[a].gain.value=l*s}}},o.prototype.setSourceWidth=function(e){this._spreadIndex=Math.min(359,Math.max(0,Math.round(e))),this.setDirection(this._azimuth,this._elevation)},o.validateAmbisonicOrder=function(e){return isNaN(e)||null==e?(s.log("Error: Invalid ambisonic order",options.ambisonicOrder,"\nUsing ambisonicOrder=1 instead."),e=1):e<1?(s.log("Error: Unable to render ambisonic order",options.ambisonicOrder,"(Min order is 1)","\nUsing min order instead."),e=1):e>n.SPHERICAL_HARMONICS_MAX_ORDER&&(s.log("Error: Unable to render ambisonic order",options.ambisonicOrder,"(Max order is",n.SPHERICAL_HARMONICS_MAX_ORDER,")\nUsing max order instead."),options.ambisonicOrder=n.SPHERICAL_HARMONICS_MAX_ORDER),e},e.exports=o},function(e,t,i){
/**
 * @license
 * Copyright 2017 Google Inc. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * limitations under the License.
 */
const n=i(5),s=i(6),o=i(1),a=i(0);function r(e,t){null==t&&(t={}),null==t.position&&(t.position=a.DEFAULT_POSITION.slice()),null==t.forward&&(t.forward=a.DEFAULT_FORWARD.slice()),null==t.up&&(t.up=a.DEFAULT_UP.slice()),null==t.minDistance&&(t.minDistance=a.DEFAULT_MIN_DISTANCE),null==t.maxDistance&&(t.maxDistance=a.DEFAULT_MAX_DISTANCE),null==t.rolloff&&(t.rolloff=a.DEFAULT_ROLLOFF),null==t.gain&&(t.gain=a.DEFAULT_SOURCE_GAIN),null==t.alpha&&(t.alpha=a.DEFAULT_DIRECTIVITY_ALPHA),null==t.sharpness&&(t.sharpness=a.DEFAULT_DIRECTIVITY_SHARPNESS),null==t.sourceWidth&&(t.sourceWidth=a.DEFAULT_SOURCE_WIDTH),this._scene=e,this._position=t.position,this._forward=t.forward,this._up=t.up,this._dx=new Float32Array(3),this._right=a.crossProduct(this._forward,this._up);let i=e._context;this.input=i.createGain(),this._directivity=new n(i,{alpha:t.alpha,sharpness:t.sharpness}),this._toEarly=i.createGain(),this._toLate=i.createGain(),this._attenuation=new s(i,{minDistance:t.minDistance,maxDistance:t.maxDistance,rolloff:t.rolloff}),this._encoder=new o(i,{ambisonicOrder:e._ambisonicOrder,sourceWidth:t.sourceWidth}),this.input.connect(this._toLate),this._toLate.connect(e._room.late.input),this.input.connect(this._attenuation.input),this._attenuation.output.connect(this._toEarly),this._toEarly.connect(e._room.early.input),this._attenuation.output.connect(this._directivity.input),this._directivity.output.connect(this._encoder.input),this._encoder.output.connect(e._listener.input),this.setPosition(t.position[0],t.position[1],t.position[2]),this.input.gain.value=t.gain}r.prototype.setPosition=function(e,t,i){this._position[0]=e,this._position[1]=t,this._position[2]=i;let n=function(e){let t=1;e>a.EPSILON_FLOAT&&(t=1-e/a.SOURCE_MAX_OUTSIDE_ROOM_DISTANCE,t=Math.max(0,Math.min(1,t)));return t}(this._scene._room.getDistanceOutsideRoom(this._position[0],this._position[1],this._position[2]));this._toLate.gain.value=n,this._toEarly.gain.value=n,this._update()},r.prototype._update=function(){for(let e=0;e<3;e++)this._dx[e]=this._position[e]-this._scene._listener.position[e];let e=Math.sqrt(this._dx[0]*this._dx[0]+this._dx[1]*this._dx[1]+this._dx[2]*this._dx[2]);e>0&&(this._dx[0]/=e,this._dx[1]/=e,this._dx[2]/=e);let t=Math.atan2(-this._dx[0],this._dx[2])*a.RADIANS_TO_DEGREES,i=Math.atan2(this._dx[1],Math.sqrt(this._dx[0]*this._dx[0]+this._dx[2]*this._dx[2]))*a.RADIANS_TO_DEGREES;this._attenuation.setDistance(e),this._directivity.computeAngle(this._forward,this._dx),this._encoder.setDirection(t,i)},r.prototype.setRolloff=function(e){this._attenuation.setRolloff(e)},r.prototype.setMinDistance=function(e){this._attenuation.minDistance=e},r.prototype.setMaxDistance=function(e){this._attenuation.maxDistance=e},r.prototype.setGain=function(e){this.input.gain.value=e},r.prototype.setOrientation=function(e,t,i,n,s,o){this._forward[0]=e,this._forward[1]=t,this._forward[2]=i,this._up[0]=n,this._up[1]=s,this._up[2]=o,this._right=a.crossProduct(this._forward,this._up)},r.prototype.setFromMatrix=function(e){this._right[0]=e.elements[0],this._right[1]=e.elements[1],this._right[2]=e.elements[2],this._up[0]=e.elements[4],this._up[1]=e.elements[5],this._up[2]=e.elements[6],this._forward[0]=e.elements[8],this._forward[1]=e.elements[9],this._forward[2]=e.elements[10],this._right=a.normalizeVector(this._right),this._up=a.normalizeVector(this._up),this._forward=a.normalizeVector(this._forward),this.setPosition(e.elements[12],e.elements[13],e.elements[14])},r.prototype.setSourceWidth=function(e){this._encoder.setSourceWidth(e),this.setPosition(this._position[0],this._position[1],this._position[2])},r.prototype.setDirectivityPattern=function(e,t){this._directivity.setPattern(e,t),this.setPosition(this._position[0],this._position[1],this._position[2])},e.exports=r},function(e,t,i){
/**
 * @license
 * Copyright 2017 Google Inc. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * limitations under the License.
 */
const n=i(0);function s(e,t){null==t&&(t={}),null==t.alpha&&(t.alpha=n.DEFAULT_DIRECTIVITY_ALPHA),null==t.sharpness&&(t.sharpness=n.DEFAULT_DIRECTIVITY_SHARPNESS),this._context=e,this._lowpass=e.createBiquadFilter(),this._lowpass.type="lowpass",this._lowpass.Q.value=0,this._lowpass.frequency.value=.5*e.sampleRate,this._cosTheta=0,this.setPattern(t.alpha,t.sharpness),this.input=this._lowpass,this.output=this._lowpass}s.prototype.computeAngle=function(e,t){let i=n.normalizeVector(e),s=n.normalizeVector(t),o=1;if(this._alpha>n.EPSILON_FLOAT){let e=i[0]*s[0]+i[1]*s[1]+i[2]*s[2];o=1-this._alpha+this._alpha*e,o=Math.pow(Math.abs(o),this._sharpness)}this._lowpass.frequency.value=.5*this._context.sampleRate*o},s.prototype.setPattern=function(e,t){this._alpha=Math.min(1,Math.max(0,e)),this._sharpness=Math.max(1,t),this.computeAngle([this._cosTheta*this._cosTheta,0,0],[1,0,0])},e.exports=s},function(e,t,i){
/**
 * @license
 * Copyright 2017 Google Inc. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * limitations under the License.
 */
const n=i(8),s=i(9),o=i(0);function a(e){let t={};for(let e in o.DEFAULT_ROOM_MATERIALS)o.DEFAULT_ROOM_MATERIALS.hasOwnProperty(e)&&(t[e]=o.ROOM_MATERIAL_COEFFICIENTS[o.DEFAULT_ROOM_MATERIALS[e]]);null==e&&(e={},Object.assign(e,o.DEFAULT_ROOM_MATERIALS));for(let i in o.DEFAULT_ROOM_MATERIALS)o.DEFAULT_ROOM_MATERIALS.hasOwnProperty(i)&&e.hasOwnProperty(i)?e[i]in o.ROOM_MATERIAL_COEFFICIENTS?t[i]=o.ROOM_MATERIAL_COEFFICIENTS[e[i]]:o.log('Material "'+e[i]+'" on wall "'+i+'" not found. Using "'+o.DEFAULT_ROOM_MATERIALS[i]+'".'):o.log('Wall "'+i+'" is not defined. Default used.');return t}function r(e){null==e&&(e={});for(let t in o.DEFAULT_ROOM_DIMENSIONS)e.hasOwnProperty(t)||(e[t]=o.DEFAULT_ROOM_DIMENSIONS[t]);return e}function l(e,t,i){let n=new Float32Array(o.NUMBER_REVERB_FREQUENCY_BANDS);e=r(e),t=function(e){null==e&&(e={});for(let t in o.DEFAULT_ROOM_MATERIALS)e.hasOwnProperty(t)||(e[t]=o.ROOM_MATERIAL_COEFFICIENTS[o.DEFAULT_ROOM_MATERIALS[t]]);return e}(t),null==i&&(i=o.DEFAULT_SPEED_OF_SOUND);let s=o.TWENTY_FOUR_LOG10/i,a=e.width*e.height*e.depth;if(a<o.ROOM_MIN_VOLUME)return n;let l=e.width*e.height,c=e.width*e.depth,u=e.depth*e.height,h=2*(l+c+u);for(let e=0;e<o.NUMBER_REVERB_FREQUENCY_BANDS;e++){let i=((t.left[e]+t.right[e])*l+(t.down[e]+t.up[e])*c+(t.front[e]+t.back[e])*u)/h;n[e]=o.ROOM_EYRING_CORRECTION_COEFFICIENT*s*a/(-h*Math.log(1-i)+4*o.ROOM_AIR_ABSORPTION_COEFFICIENTS[e]*a)}return n}function c(e){let t=[];for(let i in o.DEFAULT_REFLECTION_COEFFICIENTS)if(o.DEFAULT_REFLECTION_COEFFICIENTS.hasOwnProperty(i)){t[i]=0;for(let n=0;n<o.NUMBER_REFLECTION_AVERAGING_BANDS;n++){let s=n+o.ROOM_STARTING_AVERAGING_BAND;t[i]+=e[i][s]}t[i]/=o.NUMBER_REFLECTION_AVERAGING_BANDS,t[i]=Math.sqrt(1-t[i])}return t}function u(e,t){null==t&&(t={}),null==t.listenerPosition&&(t.listenerPosition=o.DEFAULT_POSITION.slice()),null==t.dimensions&&(t.dimensions={},Object.assign(t.dimensions,o.DEFAULT_ROOM_DIMENSIONS)),null==t.materials&&(t.materials={},Object.assign(t.materials,o.DEFAULT_ROOM_MATERIALS)),null==t.speedOfSound&&(t.speedOfSound=o.DEFAULT_SPEED_OF_SOUND),t.dimensions=r(t.dimensions);let i=a(t.materials),u=c(i),h=l(t.dimensions,i,t.speedOfSound);this.early=new s(e,{dimensions:t.dimensions,coefficients:u,speedOfSound:t.speedOfSound,listenerPosition:t.listenerPosition}),this.late=new n(e,{durations:h}),this.speedOfSound=t.speedOfSound,this.output=e.createGain(),this.early.output.connect(this.output),this._merger=e.createChannelMerger(4),this.late.output.connect(this._merger,0,0),this._merger.connect(this.output)}u.prototype.setProperties=function(e,t){let i=a(t),n=l(e,i,this.speedOfSound);this.late.setDurations(n),this.early.speedOfSound=this.speedOfSound;let s=c(i);this.early.setRoomProperties(e,s)},u.prototype.setListenerPosition=function(e,t,i){this.early.speedOfSound=this.speedOfSound,this.early.setListenerPosition(e,t,i);let n=this.getDistanceOutsideRoom(e,t,i),s=1;n>o.EPSILON_FLOAT&&(s=1-n/o.LISTENER_MAX_OUTSIDE_ROOM_DISTANCE,s=Math.max(0,Math.min(1,s))),this.output.gain.value=s},u.prototype.getDistanceOutsideRoom=function(e,t,i){let n=Math.max(0,-this.early._halfDimensions.width-e,e-this.early._halfDimensions.width),s=Math.max(0,-this.early._halfDimensions.height-t,t-this.early._halfDimensions.height),o=Math.max(0,-this.early._halfDimensions.depth-i,i-this.early._halfDimensions.depth);return Math.sqrt(n*n+s*s+o*o)},e.exports=u},function(e,t,i){
/**
 * @license
 * Copyright 2017 Google Inc. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
