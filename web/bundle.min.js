 ...
 * limitations under the License.
 */
const n=i(8),s=i(9),a=i(0);function o(e){let t={};for(let e in a.DEFAULT_ROOM_MATERIALS)a.DEFAULT_ROOM_MATERIALS.hasOwnProperty(e)&&(t[e]=a.ROOM_MATERIAL_COEFFICIENTS[a.DEFAULT_ROOM_MATERIALS[e]]);null==e&&(e={},Object.assign(e,a.DEFAULT_ROOM_MATERIALS));for(let i in a.DEFAULT_ROOM_MATERIALS)a.DEFAULT_ROOM_MATERIALS.hasOwnProperty(i)&&e.hasOwnProperty(i)?e[i]in a.ROOM_MATERIAL_COEFFICIENTS?t[i]=a.ROOM_MATERIAL_COEFFICIENTS[e[i]]:a.log('Material "'+e[i]+'" on wall "'+i+'" not found. Using "'+a.DEFAULT_ROOM_MATERIALS[i]+'".'):a.log('Wall "'+i+'" is not defined. Default used.');return t}function r(e){null==e&&(e={});for(let t in a.DEFAULT_ROOM_DIMENSIONS)e.hasOwnProperty(t)||(e[t]=a.DEFAULT_ROOM_DIMENSIONS[t]);return e}function l(e,t,i){let n=new Float32Array(a.NUMBER_REVERB_FREQUENCY_BANDS);e=r(e),t=function(e){null==e&&(e={});for(let t in a.DEFAULT_ROOM_MATERIALS)e.hasOwnProperty(t)||(e[t]=a.ROOM_MATERIAL_COEFFICIENTS[a.DEFAULT_ROOM_MATERIALS[t]]);return e}(t),null==i&&(i=a.DEFAULT_SPEED_OF_SOUND);let s=a.TWENTY_FOUR_LOG10/i,o=e.width*e.height*e.depth;if(o<a.ROOM_MIN_VOLUME)return n;let l=e.width*e.height,c=e.width*e.depth,u=e.depth*e.height,h=2*(l+c+u);for(let e=0;e<a.NUMBER_REVERB_FREQUENCY_BANDS;e++){let i=((t.left[e]+t.right[e])*l+(t.down[e]+t.up[e])*c+(t.front[e]+t.back[e])*u)/h;n[e]=a.ROOM_EYRING_CORRECTION_COEFFICIENT*s*o/(-h*Math.log(1-i)+4*a.ROOM_AIR_ABSORPTION_COEFFICIENTS[e]*o)}return n}function c(e){let t=[];for(let i in a.DEFAULT_REFLECTION_COEFFICIENTS)if(a.DEFAULT_REFLECTION_COEFFICIENTS.hasOwnProperty(i)){t[i]=0;for(let n=0;n<a.NUMBER_REFLECTION_AVERAGING_BANDS;n++){let s=n+a.ROOM_STARTING_AVERAGING_BAND;t[i]+=e[i][s]}t[i]/=a.NUMBER_REFLECTION_AVERAGING_BANDS,t[i]=Math.sqrt(1-t[i])}return t}function u(e,t){null==t&&(t={}),null==t.listenerPosition&&(t.listenerPosition=a.DEFAULT_POSITION.slice()),null==t.dimensions&&(t.dimensions={},Object.assign(t.dimensions,a.DEFAULT_ROOM_DIMENSIONS)),null==t.materials&&(t.materials={},Object.assign(t.materials,a.DEFAULT_ROOM_MATERIALS)),null==t.speedOfSound&&(t.speedOfSound=a.DEFAULT_SPEED_OF_SOUND),t.dimensions=r(t.dimensions);let i=o(t.materials),u=c(i),h=l(t.dimensions,i,t.speedOfSound);this.early=new s(e,{dimensions:t.dimensions,coefficients:u,speedOfSound:t.speedOfSound,listenerPosition:t.listenerPosition}),this.late=new n(e,{durations:h}),this.speedOfSound=t.speedOfSound,this.output=e.createGain(),this.early.output.connect(this.output),this._merger=e.createChannelMerger(4),this.late.output.connect(this._merger,0,0),this._merger.connect(this.output)}u.prototype.setProperties=function(e,t){let i=o(t),n=l(e,i,this.speedOfSound);this.late.setDurations(n),this.early.speedOfSound=this.speedOfSound;let s=c(i);this.early.setRoomProperties(e,s)},u.prototype.setListenerPosition=function(e,t,i){this.early.speedOfSound=this.speedOfSound,this.early.setListenerPosition(e,t,i);let n=this.getDistanceOutsideRoom(e,t,i),s=1;n>a.EPSILON_FLOAT&&(s=1-n/a.LISTENER_MAX_OUTSIDE_ROOM_DISTANCE,s=Math.max(0,Math.min(1,s))),this.output.gain.value=s},u.prototype.getDistanceOutsideRoom=function(e,t,i){let n=Math.max(0,-this.early._halfDimensions.width-e,e-this.early._halfDimensions.width),s=Math.max(0,-this.early._halfDimensions.height-t,t-this.early._halfDimensions.height),a=Math.max(0,-this.early._halfDimensions.depth-i,i-this.early._halfDimensions.depth);return Math.sqrt(n*n+s*s+a*a)},e.exports=u},function(e,t,i){
/**
 * @license
 * Copyright 2017 Google Inc. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
