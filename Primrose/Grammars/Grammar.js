...
import { FinalTokenType, IntermediateTokenType, isFinalTokenType, Token } from "./Token";
    ...
    toHTML(parent, txt, theme, fontSize) {
        ...
        for (var y = 0; y < tokenRows.length; ++y) {
            ...
            if (t.type === FinalTokenType.newLines) {
                ...
                const elem = Span(styles(fontWeight(style.fontWeight || theme.regular.fontWeight), fontStyle(style.fontStyle || theme.regular.fontStyle || ""), color(style.foreColor || theme.regular.foreColor), backgroundColor(style.backColor || theme.regular.backColor), getMonospaceFamily()), t.value);
