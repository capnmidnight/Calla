...
class BufferList {
     ...
     */
    _promiseGenerator(resolve, reject) {
        if (typeof resolve !== 'function') {
            throwError('BufferList: Invalid Promise resolver.');
        } else {
     ...
     */
    _launchAsyncLoadTask(taskId) {
        const that = this;
        this._context.decodeAudioData(
            getArrayBufferFromBase64String(this._bufferData[taskId]),
     ...
     * @param {Number} taskId Task ID number from the ordered list |bufferData|.
     */
    _launchAsyncLoadTaskXHR(taskId) {
...
class FOARenderer {
     ...
     */
    _initializeCallback(resolve, reject) {
...
const versionString = "Calla v0.5.9";
...
class CallaClient extends EventBase {
    ...
    _prepareAsync() {
        if(!this._prepTask) {
            ...
            this._prepTask = Promise.resolve().then(function () { return _interopNamespace(require(`https://${this.host}/libs/lib-jitsi-meet.min.js`)); });
        }
...
exports.AudioListenerBase = AudioListenerBase;
exports.AudioListenerNew = AudioListenerNew;
exports.AudioListenerOld = AudioListenerOld;
exports.AudioManager = AudioManager;
exports.BaseAnalyzed = BaseAnalyzed;
exports.BaseListener = BaseListener;
exports.BaseSource = BaseSource;
exports.BaseSpatializer = BaseSpatializer;
exports.BaseWebAudio = BaseWebAudio;
exports.CallaClient = CallaClient;
exports.EventBase = EventBase;
exports.InterpolatedPose = InterpolatedPose;
exports.ManualBase = ManualBase;
exports.ManualStereo = ManualStereo;
exports.ManualVolume = ManualVolume;
exports.MockAudioContext = MockAudioContext;
exports.PannerBase = PannerBase;
