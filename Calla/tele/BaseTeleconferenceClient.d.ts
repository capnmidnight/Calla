...
export declare abstract class BaseTeleconferenceClient extends TypedEventBase<CallaTeleconferenceEvents> implements ITeleconferenceClientExt {
    ...
    constructor(fetcher: IFetcher, audio: AudioManager, needsVideoDevice?: boolean);
    ...
    enablePreferredAudioInput(allowAny: boolean): Promise<void>;
    getPreferredVideoInput(allowAny: boolean): Promise<MediaDeviceInfo>;
    enablePreferredVideoInput(allowAny: boolean): Promise<void>;
    private getDevices;
    ...
    enablePreferredAudioOutput(allowAny: boolean): Promise<void>;
