...
import type { blobFetchingCallback, ErsatzEventTarget, progressCallback, scriptLoadingCallback } from "kudzu";
import { arrayClear, once, splitProgress, using } from "kudzu";
import {
    addLogger,
...
import { JitsiMetadataClient } from "./JitsiMetadataClient";
...
export class JitsiTeleconferenceClient
    ...
    async disconnect(): Promise<void> {
        ...
        if (this.conferenceState !== HubConnectionState.Disconnected) {
            await this.leave();
        }
