...
export class FOARotator implements IDisposable {
    ...
    private _inZ: GainNode;
    private _m0: GainNode;
    private _m1: GainNode;
    private _m2: GainNode;
    private _m3: GainNode;
    private _m4: GainNode;
    private _m5: GainNode;
    private _m6: GainNode;
    private _m7: GainNode;
    private _m8: GainNode;
    private _outX: GainNode;
    ...
    getRotationMatrix4(): ReadonlyMat4 {
        mat4.set(rotationMatrix4,
            this._m0.gain.value, this._m1.gain.value, this._m2.gain.value, 0,
            this._m3.gain.value, this._m4.gain.value, this._m5.gain.value, 0,
            this._m6.gain.value, this._m7.gain.value, this._m8.gain.value, 0,
            0, 0, 0, 1);
