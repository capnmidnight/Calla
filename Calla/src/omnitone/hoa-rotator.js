...
function computeUVWCoeff(m, n, l) {
    ...
    vec3.set(UVWCoeff, Math.sqrt((l + m) * (l - m) * reciprocalDenominator), 0.5 * (1 - 2 * d) * Math.sqrt((1 + d) *
        (l + Math.abs(m) - 1) *
        (l + Math.abs(m)) *
...
//# sourceMappingURL=hoa-rotator.js.map