 ...
 */
export const DEFAULT_REFLECTION_COEFFICIENTS = {
    [Direction.Left]: 0,
    [Direction.Right]: 0,
    [Direction.Front]: 0,
    [Direction.Back]: 0,
 ...
 */
export const DEFAULT_REVERB_DURATIONS = new Float32Array(NUMBER_REVERB_FREQUENCY_BANDS);
export var Material;
(function (Material) {
 ...
 */
export const ROOM_AIR_ABSORPTION_COEFFICIENTS = [0.0006, 0.0006, 0.0007, 0.0008, 0.0010, 0.0015, 0.0026, 0.0060, 0.0207];
/**
