...
export default class RTC extends Listenable {
     ...
     */
    static getStreamID(stream: any): any;
    /**
     * Returns the id of the given track.
     * @param {MediaStreamTrack} track
     */
    static getTrackID(track: any): any;
    /**
     ...
     */
    static getEventDataForActiveDevice(device: any): any;
    /**
     ...
     */
    static stopMediaStream(mediaStream: any): void;
    /**
     ...
     */
    initializeBridgeChannel(peerconnection?: any, wsUrl?: string): void;
    /**
