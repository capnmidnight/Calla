...
export default class E2EEcontext {
     ...
     */
    handleReceiver(receiver: any, kind: string, participantId: string): void;
    /**
     ...
     */
    handleSender(sender: any, kind: string, participantId: string): void;
    /**
     ...
     */
    setSignatureKey(participantId: string, key: any): void;
}
