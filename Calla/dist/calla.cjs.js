 ...
 */
function once$1(target, resolveEvt, rejectEvt, timeout) {
...
class CallaClient extends EventBase {
    ...
    _prepareAsync() {
        if (!this._prepTask) {
            ...
            this._prepTask = Promise.resolve().then(function () { return /*#__PURE__*/_interopNamespace(require(`https://${this.host}/libs/lib-jitsi-meet.min.js`)); });
        }
...
/**
 * @param {import("../../lib/three.js/src/math/Matrix4").Matrix4} matrix
 * @param {import("../../lib/three.js/src/math/Vector3").Vector3} R
 * @param {import("../../lib/three.js/src/math/Vector3").Vector3} U
 * @param {import("../../lib/three.js/src/math/Vector3").Vector3} F
 * @param {import("../../lib/three.js/src/math/Vector3").Vector3} P
 */
function setRightUpFwdPosFromMatrix(matrix, R, U, F, P) {
 ...
 * @param {import("../../lib/three.js/src/math/Matrix4").Matrix4} matrix
 */
function setMatrixFromRightUpFwdPos(R, U, F, P, matrix) {
    R.normalize();
    U.normalize();
    F.normalize();
    matrix.set(
...
class BaseThreeJSAudioObject extends Object3D {
    /**
...
class CallaAudioListener extends BaseThreeJSAudioObject {
    /**
     * @param {import("../audio/AudioManager").AudioManager} audio
     * @param {string?} name
     */
...
class CallaAudioSource extends BaseThreeJSAudioObject {
    /**
     * Creates a new sound effect from a series of fallback paths
     * for media files.
     * @param {import("../audio/AudioManager").AudioManager} audio
...
exports.AudioActivityEvent = AudioActivityEvent;
exports.AudioListenerNew = AudioListenerNew;
exports.AudioListenerOld = AudioListenerOld;
exports.AudioManager = AudioManager;
exports.CallaAudioListener = CallaAudioListener;
exports.CallaAudioSource = CallaAudioSource;
exports.CallaClient = CallaClient;
exports.DirectSource = DirectSource;
exports.EventBase = EventBase;
exports.InterpolatedPose = InterpolatedPose;
exports.LRUCache = LRUCache;
exports.MockAudioContext = MockAudioContext;
exports.PannerNew = PannerNew;
exports.PannerOld = PannerOld;
exports.Pose = Pose;
exports.ResonanceScene = ResonanceScene;
exports.ResonanceSource = ResonanceSource;
exports.add = add;
...
exports.getBlobWithProgress = getBlobWithProgress;
exports.getBufferWithProgress = getBufferWithProgress;
exports.getFile = getFile;
exports.getFileWithProgress = getFileWithProgress;
exports.getObject = getObject;
exports.getObjectWithProgress = getObjectWithProgress;
exports.getResponse = getResponse;
exports.isBoolean = isBoolean;
exports.isFunction = isFunction;
exports.isGoodNumber = isGoodNumber;
exports.isNumber = isNumber;
exports.isString = isString;
exports.lerp = lerp;
exports.once = once$1;
exports.project = project;
exports.setMatrixFromRightUpFwdPos = setMatrixFromRightUpFwdPos;
exports.setRightUpFwdPosFromMatrix = setRightUpFwdPosFromMatrix;
exports.slerpVectors = slerpVectors;
exports.splitProgress = splitProgress;
exports.unproject = unproject;
exports.until = until;
exports.versionString = versionString;
exports.wait = wait;
exports.when = when;
//# sourceMappingURL=calla.cjs.js.map
