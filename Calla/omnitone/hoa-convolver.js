 ...
 */
import { ChannelMerger, ChannelSplitter, connect, Convolver, disconnect, gain, Gain } from "kudzu/audio";
/**
...
export class HOAConvolver {
    ...
    _numberOfChannels;
    _inputSplitter;
    _stereoMergers = new Array();
    _convolvers = new Array();
    _stereoSplitters = new Array();
     ...
     */
    constructor(ambisonicOrder, hrirBufferList) {
        ...
        this._inverter = Gain("foa-convolver-inverter", gain(-1), [0, 1, this._binauralMerger]);
        this._positiveIndexSphericalHarmonics = Gain("foa-convolver-positiveIndexSphericalHarmonics", [0, 0, this._binauralMerger], [0, 1, this._binauralMerger]);
        this._negativeIndexSphericalHarmonics = Gain("foa-convolver-negativeIndexSphericalHarmonics", this._inverter, [0, 0, this._binauralMerger]);
